...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
	...
	private void _initKPSPublicSoapProxy() {
		try {
			...
			if (kPSPublicSoap != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) kPSPublicSoap)._setProperty("javax.xml.rpc.service.endpoint.address",
							_endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) kPSPublicSoap)
	...
	public boolean TCKimlikNoDogrula(long TCKimlikNo, java.lang.String ad, java.lang.String soyad, int dogumYili)
